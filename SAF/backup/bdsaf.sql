...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-11-2024 a las 00:59:50
...
CREATE TABLE IF NOT EXISTS `tbfactura` (
  ...
  `tbfacturaidventa` mediumtext NOT NULL,
...
INSERT INTO `tbfactura` (`tbfacturaid`, `tbfacturaidentificador`, `tbfacturaidventa`, `tbfacturacreadoen`, `tbfacturamodificadoen`, `tbfacturaurlqr`, `tbfacturaestado`) VALUES
(0, 'FAC-1731364799', 'VTN-1731365688', '2024-11-11', '2024-11-11', '../images/facturaQr/', 1);
...
(22, 'LOTE-1729609765', 'MAG-1731339421', 11, '2024-11-11', '2024-11-11', 1);
...
--
-- Estructura de tabla para la tabla `tbtrasaccionventa`
--

CREATE TABLE IF NOT EXISTS `tbtrasaccionventa` (
  `tbidentificadorventa` mediumtext NOT NULL,
  `tbtransaccionventasub` float NOT NULL,
  `tbtransacciontipopago` tinyint(1) NOT NULL,
  `tbtransaccionimpuestoid` mediumtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'VTN-1731365688', 'USUARIO-1725987630', '2024-11-11 16:54:48', '2024-11-11 16:54:48', 1),
(2, 'VTN-1731369502', 'USUARIO-1725987630', '2024-11-11 17:58:22', '2024-11-11 17:58:22', 1);
...
--
-- Volcado de datos para la tabla `tbventaproducto`
--

INSERT INTO `tbventaproducto` (`tbventaproductoid`, `tbventaidentificador`, `tbventaproductoidentificador`, `tbventacantidadproducto`) VALUES
(1, 'VTN-1731339441', 'PROD-22102024084409', 1),
(2, 'VTN-1731339443', 'PROD-22102024084409', 1),
(3, 'VTN-1731339444', 'PROD-22102024084409', 1),
(4, 'VTN-1731365688', 'PROD-22102024084409', 1),
(5, 'VTN-1731369502', 'PROD-22102024084409', 1);
COMMIT;
