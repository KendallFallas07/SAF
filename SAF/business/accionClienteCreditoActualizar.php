...
$clienteCreditoIdentificador = $_POST['idAModificar'] ?? '';
...
$clienteCreditoViejo = $controladora->buscarPorIdentificador($clienteCreditoIdentificador);

$datos = $clienteCreditoViejo[0];

$dateNew = new DateTime();
$formattedCreatedAt = $datos['tbclientecreditocreadoen'];
$formattedModifiedAt = $dateNew->format('Y-m-d');



$ClienteCredito = new ClienteCredito($id, $clienteId ,$clienteCreditoIdentificador, $clienteCreditoCantidad, $clienteCreditoPorcentaje, $clienteCreditoPlazo, $clienteCreditoFechaInicio, $clienteCreditoFechaVencimiento, $formattedCreatedAt, $formattedModifiedAt, 1);

if ($controladora->actualizar($ClienteCredito)) {
