...
$controladora = new ControladoraSubcategoria();
...
$nombresRegistrados = $controladora->obtenerNombresSubcategorias();
...
foreach ($nombresRegistrados as $key){
    ...
    $probabilidad = porcentajeIncidencia($nombre, $key['tbsubcategorianombre']);
